...
ARCHITECTURE output_control_logic OF output_control IS
	...
	BEGIN
		...
		CASE Opcode IS
            		WHEN opAritmetica =>
                		ALUSrc <= '0'; ALUOp <= "10"; MemRead <= '0'; MemWrite <= '0'; Branch <= '0'; RegWrite <= '1'; MemtoReg <= '0';

            		WHEN LW =>
                		ALUSrc <= '1'; ALUOp <= "00"; MemRead <= '1'; MemWrite <= '0'; Branch <= '0'; RegWrite <= '1'; MemtoReg <= '1';

            		WHEN SW =>
                		ALUSrc <= '1'; ALUOp <= "00"; MemRead <= '0'; MemWrite <= '1'; Branch <= '0'; RegWrite <= '0'; MemtoReg <= '0';
